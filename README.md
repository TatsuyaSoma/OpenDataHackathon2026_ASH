...
src/
  ...
  hooks/
    ...
    use-nearest-wbgt.ts                      # 地図に最も近いWBGT実況値取得フック
    use-tokyo-wbgt-grid.ts                    # 都内全地点のWBGT実況値取得フック（広域ヒートマップ用）
  utils/
